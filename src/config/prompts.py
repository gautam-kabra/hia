SPECIALIST_PROMPTS = {
    ...
    - **Health Score**: [Provide a numeric score from 0-100 based on overall biomarkers, where 100 is perfect health]

    Note: Focus on early detection and prevention. Explain how current blood values might indicate future health risks and what can be done to prevent them. Ensure the Health Score is clearly labeled as 'Health Score: [Score]' at the end. """
}